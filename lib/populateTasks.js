...
function createTaskInfo(taskTypeId) {
    ...
    var task = {
        ...
        "portMappings": process.env["TASK" + taskTypeId + "_EXPOSE_PORT"] 
            ? [{ port: parseInt(process.env["TASK" + taskTypeId + "_EXPOSE_PORT"]), service_port: process.env["TASK" + taskTypeId + "_SERVICE_PORT"] ? parseInt(process.env["TASK" + taskTypeId + "_SERVICE_PORT"]) : 0}]
            : null
    };
    var taskEnv = {};
