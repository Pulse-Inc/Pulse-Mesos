...
function createContainerInfo(taskTypeId, mappings) {
...
function createTaskInfo(taskTypeId) {
    ...
    var mappings = [];
    if(process.env["TASK" + taskTypeId + "_HEALTHCHECK"] != null)
    ...
    var task = {
        ...
        "containerInfo": createContainerInfo(taskTypeId, mappings), // Mesos.ContainerInfo object
